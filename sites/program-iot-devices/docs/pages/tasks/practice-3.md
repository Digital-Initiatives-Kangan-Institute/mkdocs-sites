...
!!! abstract "Instructions"
    In this activity you'll build a night guard for a museum display case: an LDR inside the case and a PIR on the gallery floor are correlated so that a light spike shortly after motion raises an ALARM, while either event on its own is only a WARNING. The build brings together structured logging, sorting, lookup tables, 2-D arrays, selection logic, non-blocking timing and an OLED status screen into one program running on a single ESP32-S2.
...
!!! note "Wokwi link"
    [https://wokwi.com/projects/476038822892508161](https://wokwi.com/projects/476038822892508161)
